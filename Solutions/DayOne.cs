    ...
    class DayOne
    {
        public static void Solution()
        {
            ...
            foreach (int expense in expenses)
            {
                foreach (int e in expenses)
                {
                    foreach (int y in expenses)
                    {
                        if (expense + e + y == 2020)
                        {
                            threeAnswer = expense * e * y;
                            break;
                        }
                    }
                }
            ...
            Console.WriteLine($"Part one solution: {answer}, Part two solution: {threeAnswer}");
        }
    }
}
